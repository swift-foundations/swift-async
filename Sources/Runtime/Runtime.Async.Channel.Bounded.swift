...
extension Runtime.Async.Channel {
    ...
    /// ## Usage
    /// ```swift
    /// let channel = Runtime.Async.Channel.Bounded<Message>(capacity: 10)
    ///
...
extension Runtime.Async.Channel.Bounded {
    struct State {
...
extension Runtime.Async.Channel.Bounded {
    ...
    public struct Send: Sendable {
        let channel: Runtime.Async.Channel.Bounded<Element>

        init(channel: Runtime.Async.Channel.Bounded<Element>) {
